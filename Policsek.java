...
public class Policsek { //23*23 4297449167656385616 15*15 6929569864609468836
    ...
    public static long on(Grid grid) {
        ...
        for (int i = 0; i < sum - 1; i++) {
            ...
            while (!currentCell.getVisited()) {
                ...
                if (!currentCell.unVisitedNeighbors().isEmpty()) {
                    int index = random.nextInt(currentCell.unVisitedNeighbors().size());
                    Cell neighbour = currentCell.unVisitedNeighbors().get(index);
