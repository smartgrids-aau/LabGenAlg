...
public class SectoredBinaryTree2x2 {
    ...
    public static long on(Grid grid) {
        ...
        int yOdd = grid.getGrid().length % 2;
        int xOdd = grid.getGrid()[0].length % 2;
        int yLength = grid.getGrid().length - yOdd;
        int xLength = grid.getGrid()[0].length - xOdd;

        for (int i = 0; i < yLength - 1; i = i + 2) {
            for (int j = 0; j < xLength - 1; j = j + 2) {
                ...
                if (i < (yLength / 2) && j < (xLength / 2)) {
                ...
                } else if (!(i < (yLength / 2)) && !(j < (xLength / 2)) && !(i == (yLength / 2 + yOdd) && j == (xLength / 2) + xOdd)) {
                    if (first.linked(first.getNorth()) || second.linked(second.getNorth())) {
                        link = random.nextInt(2);
                    ...
                    } else if (first.linked(first.getWest()) || fourth.linked(fourth.getWest())) {
                        link = random.nextInt(2);
        ...
        if (yOdd == 1) {
            for (int i = 0; i < xLength; i++) {
                Cell currentCell = grid.getCell(i, xLength - 1 + xOdd);
        ...
        if (xOdd == 1) {
            for (int j = 0; j < yLength; j++) {
                Cell currentCell = grid.getCell(yLength - 1 + yOdd, j);
                int link = random.nextInt(2);
                if (link == 0) {
        ...
        if ((yOdd + xOdd) > 0) {
            Cell corner = grid.getCell(yLength - 1 + yOdd, xLength - 1 + xOdd);
        ...
        for (int i = 0; i < yLength - 1; i = i + 2) {
            for (int j = 0; j < xLength - 1; j = j + 2) {
                ...
                if (i < (yLength / 2) && j < (xLength / 2)) {
                    ...
                    if ((first.linked(first.getNorth()) || second.linked(second.getNorth())) &&
                            !(first.linked(first.getWest()) || fourth.linked(fourth.getWest()))) {
                        link = random.nextInt(2);
                    ...
                    } else if (!(first.linked(first.getNorth()) || second.linked(second.getNorth())) &&
                            (first.linked(first.getWest()) || fourth.linked(fourth.getWest()))) {
                        link = random.nextInt(2);
